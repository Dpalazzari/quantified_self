...
$('document').ready(function() {
  ...
  prependCheckedFood('button#add-breakfast', '#breakfast-table');
  prependCheckedFood('button#add-lunch', '#lunch-table');
  prependCheckedFood('button#add-dinner', '#dinner-table');
  prependCheckedFood('button#add-snacks', '#snack-table');
...
function prependCheckedFood(button, mealTable){
  $(button).on('click', function(){
    ...
    $.each(rows, function(){
      ...
      $(mealTable).prepend("<tr id='food-row'><td class='food-name'>" + food + 
